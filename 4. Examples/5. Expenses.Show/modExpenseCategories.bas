...
Sub Process_Globals
	...
	Private expensecategory As VMGijgoTable
...
Sub Code
	...
	'
	expensecategory = vm.CreateGijgoTable("expensecategory", "id", Me)
	...
	expensecategory.AddEditTrash
	expensecategory.autoLoad = True
	...
	mdlExpenseCategory.Container.AddControlS(ecText, 2, 1, 12, 12, 12, 12)
	mdlExpenseCategory.Container.AddControlS(ecDescription, 3, 1, 12, 12, 12, 12)
	mdlExpenseCategory.Container.AddControlS(ecBudget, 4, 1, 12, 12, 12, 12)
	 
	mdlExpenseCategory.SetClickOutsideToClose(False)
	mdlExpenseCategory.SetCloseOnEsc(False)
...
Sub expensecategory_edit(e As BANanoEvent)
	'get the record corresponding to the row
	Dim rec As Map = expensecategory.GetRecordFromEvent(e)
...
Sub expensecategory_delete(e As BANanoEvent)
