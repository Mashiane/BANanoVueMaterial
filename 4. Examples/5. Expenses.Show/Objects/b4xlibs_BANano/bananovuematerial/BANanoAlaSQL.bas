...
End Sub
'
Sub SchemaAddInt(bools As List) As BANanoAlaSQL
	For Each b As String In bools
		Schema.Put(b, DB_INT)
	Next
	Return Me
...
Sub SchemaAddFloat(bools As List) As BANanoAlaSQL
	For Each b As String In bools
...
Sub SchemaAddBlob(bools As List) As BANanoAlaSQL
	For Each b As String In bools
...
Sub SchemaAddText(bools As List) As BANanoAlaSQL
	For Each b As String In bools
...
Sub SchemaAddDate(bools As List) As BANanoAlaSQL
	For Each b As String In bools
...
Sub Delete(tblName As String, primaryKey As String, primaryValue As String) As AlaSQLResultSet
...
Sub Read(tblName As String, primaryKey As String, primaryValue As String) As AlaSQLResultSet
	Dim qw As Map = CreateMap()
	qw.Put(primaryKey, primaryValue)
	Dim qry As AlaSQLResultSet = SelectWhere(tblName, Array("*"), qw, Array("="), Array(primaryKey))
	Return qry
End Sub
...
Sub Exists(tblName As String, primaryKey As String, primaryValue As String) As AlaSQLResultSet
	Dim qw As Map = CreateMap()
	qw.Put(primaryKey, primaryValue)
	Dim qry As AlaSQLResultSet = SelectWhere(tblName, Array(primaryKey), qw, Array("="), Array(primaryKey))
	Return qry
End Sub
