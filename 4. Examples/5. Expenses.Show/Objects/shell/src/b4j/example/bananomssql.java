...
public class bananomssql {
    public static RemoteObject myClass;
	public bananomssql() {
	}
    public static PCBA staticBA = new PCBA(null, bananomssql.class);
