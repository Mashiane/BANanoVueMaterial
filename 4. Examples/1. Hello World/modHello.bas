...
Sub Code(vmx As BANanoVM)
	...
	For rCnt = 1 To 9 
		cont.Grid.SetBorder(rCnt,1,"1px", vm.vue.COLOR_BLUEGREY, vm.vue.BORDER_DOTTED)
		cont.Grid.SetBorder(rCnt,2,"1px", vm.vue.COLOR_BLUEGREY, vm.vue.BORDER_DOTTED)
		cont.Grid.SetBorder(rCnt,3,"1px", vm.vue.COLOR_BLUEGREY, vm.vue.BORDER_DOTTED)
		'
