...
Public Sub Initialize(v As BANanoVue, sid As String, eventHandler As Object) As VMGMap
	...
	GMap.SetRef(ID)
	GMap.RemoveAttr(":required").RemoveAttr("v-show").RemoveAttr(":disabled")
	...
	module = eventHandler
	options.Initialize
	markers.initialize(vue,markerName).SetTag("gmap-marker").SetAttrSingle(":position","m.position")
	markers.RemoveAttr(":required").RemoveAttr("v-show").RemoveAttr(":disabled")
	...
	infoWindow.RemoveAttr(":required").RemoveAttr("v-show").RemoveAttr(":disabled")
	...
	kmlLayer.RemoveAttr(":required").RemoveAttr("v-show").RemoveAttr(":disabled")
...
Sub SetAttrSingle(prop As String, val As Object) As VMGMap
	GMap.SetAttrSingle(prop, val)
	Return Me
End Sub
