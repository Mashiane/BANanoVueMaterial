...
public class modskeleton extends Object{
public static modskeleton mostCurrent = new modskeleton();

public static BA ba;
static {
		ba = new  anywheresoftware.b4j.objects.FxBA("b4j.example", "b4j.example.modskeleton", null);
		ba.loadHtSubs(modskeleton.class);
        if (ba.getClass().getName().endsWith("ShellBA")) {
			
			ba.raiseEvent2(null, true, "SHELL", false);
			ba.raiseEvent2(null, true, "CREATE", true, "b4j.example.modskeleton", ba);
		}
	}
    public static Class<?> getObject() {
		return modskeleton.class;
	}
...
b4j.example.vmcontainer _cont = null;
 ...
 //BA.debugLineNum = 9;BA.debugLine="Log(\"modSkeleton.Code\")";
...
_cont = _vm._createcontainer /*b4j.example.vmcontainer*/ (_name,modskeleton.getObject());
...
_cont._addrows /*b4j.example.vmgrid*/ ((int) (2))._addcolumns12 /*b4j.example.vmgrid*/ ();
 //BA.debugLineNum = 19;BA.debugLine="vm.Container.AddComponent(1,1,cont.tostring)";
...
_vm = new b4j.example.bananovm();
 //BA.debugLineNum = 4;BA.debugLine="Public name As String = \"skeletoncode\"";
_name = "skeletoncode";
