...
public b4j.example.vmcol  _addelements(anywheresoftware.b4a.objects.collections.List _lst) throws Exception{
 //BA.debugLineNum = 18;BA.debugLine="Sub AddElements(lst As List) As VMCol";
 //BA.debugLineNum = 19;BA.debugLine="Col.AddElements(lst)";
_col._addelements /*String*/ (_lst);
...
public b4j.example.vmcol  _initialize(anywheresoftware.b4a.BA _ba,b4j.example.bananovue _v,String _sid) throws Exception{
innerInitialize(_ba);
...
_col._settag /*b4j.example.vmelement*/ ("div")._addclass /*b4j.example.vmelement*/ ("md-layout-item");
...
public b4j.example.vmcol  _setgutter(boolean _b) throws Exception{
 //BA.debugLineNum = 33;BA.debugLine="Sub SetGutter(b As Boolean) As VMCol";
 //BA.debugLineNum = 34;BA.debugLine="Col.SetGutter(True)";
_col._setgutter /*b4j.example.vmelement*/ (__c.True);
 //BA.debugLineNum = 35;BA.debugLine="Return Me";
if (true) return (b4j.example.vmcol)(this);
 //BA.debugLineNum = 36;BA.debugLine="End Sub";
return null;
}
public b4j.example.vmcol  _sethidden(boolean _xsmall,boolean _small,boolean _medium,boolean _large,boolean _xlarge) throws Exception{
...
_col._sethidden /*b4j.example.vmelement*/ (_xsmall,_small,_medium,_large,_xlarge);
 //BA.debugLineNum = 25;BA.debugLine="Return Me";
if (true) return (b4j.example.vmcol)(this);
 //BA.debugLineNum = 26;BA.debugLine="End Sub";
return null;
}
public b4j.example.vmcol  _setpadding(Object _p) throws Exception{
 //BA.debugLineNum = 117;BA.debugLine="Sub SetPadding(p As Object) As VMCol";
 //BA.debugLineNum = 118;BA.debugLine="Col.SetPaddingAll(p)";
_col._setpaddingall /*b4j.example.vmelement*/ (_p);
 //BA.debugLineNum = 119;BA.debugLine="Return Me";
if (true) return (b4j.example.vmcol)(this);
 //BA.debugLineNum = 120;BA.debugLine="End Sub";
return null;
}
public b4j.example.vmcol  _setprimary(boolean _b) throws Exception{
 //BA.debugLineNum = 76;BA.debugLine="Sub SetPrimary(b As Boolean) As VMCol";
 //BA.debugLineNum = 77;BA.debugLine="Col.SetPrimary(True)";
_col._setprimary /*b4j.example.vmelement*/ (__c.True);
 //BA.debugLineNum = 78;BA.debugLine="Return Me";
if (true) return (b4j.example.vmcol)(this);
 //BA.debugLineNum = 79;BA.debugLine="End Sub";
return null;
}
public b4j.example.vmcol  _setsizes(int _xsmall,int _small,int _medium,int _large,int _xlarge) throws Exception{
...
_col._setsizes /*b4j.example.vmelement*/ (_xsmall,_small,_medium,_large,_xlarge);
...
public b4j.example.vmcol  _setvshow(Object _vif) throws Exception{
 //BA.debugLineNum = 53;BA.debugLine="Sub SetVShow(vif As Object) As VMCol";
 //BA.debugLineNum = 54;BA.debugLine="Col.SetVShow(vif)";
_col._setvshow /*b4j.example.vmelement*/ (BA.ObjectToString(_vif));
